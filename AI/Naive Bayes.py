...
# 테스트 
print(nb_fitted.predict_proba(train_scaled)[[1, 7, 12]])
print("----------------------------------------------------------------")
print(f"[Test #1] 예측값 : {nb_fitted.predict(train_scaled)[1]}")
print(f"[Test #2] 예측값 : {nb_fitted.predict(train_scaled)[7]}")
print(f"[Test #3] 예측값 : {nb_fitted.predict(train_scaled)[12]}")
print("----------------------------------------------------------------")
